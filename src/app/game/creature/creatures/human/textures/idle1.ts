...
export const bodyPart = {
  ...
  [HumanoidCreatureDefinitions.BodyPart.LeftFoot]: [new Rect(9, 14, 1, 1), new Rect(9, 15, 2, 1)],
  [HumanoidCreatureDefinitions.BodyPart.LeftHand]: [new Rect(10, 8, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.LeftLeg]: [new Rect(7, 11, 2, 1), new Rect(8, 12, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.RightArm]: [new Rect(1, 5, 1, 3)],
  [HumanoidCreatureDefinitions.BodyPart.RightFoot]: [new Rect(2, 14, 1, 1), new Rect(1, 15, 2, 1)],
  [HumanoidCreatureDefinitions.BodyPart.RightHand]: [new Rect(0, 8, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.RightLeg]: [new Rect(3, 11, 2, 1), new Rect(2, 12, 2, 2)],
