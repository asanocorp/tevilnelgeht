...
const bodyPart = {
  ...
  [HumanoidCreatureDefinitions.BodyPart.LeftFoot]: [new Rect(8, 12, 1, 1), new Rect(8, 13, 2, 1)],
  [HumanoidCreatureDefinitions.BodyPart.LeftHand]: [new Rect(10, 6, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.LeftLeg]: [new Rect(7, 10, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.RightArm]: [new Rect(1, 4, 1, 3)],
  [HumanoidCreatureDefinitions.BodyPart.RightFoot]: [new Rect(2, 12, 1, 1), new Rect(1, 13, 2, 1)],
  [HumanoidCreatureDefinitions.BodyPart.RightHand]: [new Rect(0, 7, 2, 2)],
  [HumanoidCreatureDefinitions.BodyPart.RightLeg]: [new Rect(3, 10, 2, 1), new Rect(2, 11, 2, 1)],
...
export const sockets = {
  ...
  rightLeg: [new Rect(3, 10, 2, 1), new Rect(2, 11, 2, 1)],
  leftLeg: [new Rect(7, 10, 2, 2)],
  rightFoot: [new Rect(2, 12, 1, 1), new Rect(1, 13, 2, 1)],
